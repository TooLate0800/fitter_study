...
int xyminimizer(const char * minName = "Minuit", const char * algoName = ""){
  ...
  min->SetLimitedVariable(0, "Rp", variable[0], step[0],  0.0, 2.5);
...
int main(Int_t argc, char *argv[]){
 ...
 for(int i = 0; i <  1; i++){//repetition times
  string fname1="../generator/test_input/dipole.txt";//input files 
  ...
  //readdata(fname1, fname2, modiFactor);
          ...
          //double para[2];
          //para[0]=0.79962e-00; para[1]=9.83484e-01;
          ...
          ofstream outFile1;
          outFile1.open("fit_result/dipole_alarcon_1e4.txt", std::ios_base::app);//output file
          //outFile1<<Rfit<<endl;
          outFile1.close();
//      }
  }
