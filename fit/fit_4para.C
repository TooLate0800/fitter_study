...
int xyminimizer(const char * minName = "Minuit", const char * algoName = ""){
  ...
  step[0]=0.0001;step[1]=0.01;step[2]=0.0001;step[3]=0.01;step[4]=0.01;//step[5]=0.00001;
  variable[0]=0.84;variable[1]=9.19364e-02;variable[2]=1.0;variable[3]=0.001;variable[4]=9.19364e-02;//variable[5]=9.19364e-02;
...
int main(Int_t argc, char *argv[]){
 for(int i = 0; i <  1; i++){
  string fname1=Form("/var/phy/project/mepg/jz271/fitter_study/generator/Mainz_PRad_range/Model_1/1GeV_table_%d.txt",i+1);
  ...
  ofstream outFile1;
  outFile1.open("fit_result/R22check_Model1_1e4.txt", std::ios_base::app);
  //outFile1<<Rfit<<endl;
  outFile1.close();
