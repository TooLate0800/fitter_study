...
int main(Int_t argc, char *argv[]){
  ...
  for (int j = 0; j <  1; j++){//models
       for(int i = 0; i <  1; i++){//table
           ...
           for (int l=0; l<number_of_sets; l++){
               fname[l] = Form("../generator_31norms/xs_pseudo_GMisDipole_1e3/Model%d_norm%d_table_%d.txt",j+1, l+1, i+1);
           ...
           //for (int l=0; l<34; l++){
           //    //fname[l] = Form("../generator_31norms/xs_pseudo_GMisDipole/Model%d_norm%d_table_%d.txt",j+1, l+1, i+1); 
           ...
           outFile1.open(Form("result/poly10_xsfit_RE_GMisDipole_Cut1GeV_Model%d.txt",j+1), std::ios_base::app);
           //outFile1<<REfit<<endl;
           outFile1.close();
           outFile2.open(Form("result/poly10_xsfit_all_GMisDipole_Cut1GeV_Model%d.txt",j+1), std::ios_base::app);
           //outFile2<<chi2fit<<" "<<REfit<<" "<<REfiterr<<endl;
